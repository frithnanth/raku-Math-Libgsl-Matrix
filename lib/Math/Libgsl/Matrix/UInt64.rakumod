...
sub uint64-mat-view-vector(Math::Libgsl::Matrix::UInt64::View $mv, Math::Libgsl::Vector::UInt64 $v, size_t $n1, size_t $n2 --> Math::Libgsl::Matrix::UInt64) is export {
  Math::Libgsl::Matrix::UInt64.new: matrix => mgsl_matrix_ulong_view_vector($mv.view, $v.vector, $n1, $n2);
}
sub uint64-mat-view-vector-tda(Math::Libgsl::Matrix::UInt64::View $mv, Math::Libgsl::Vector::UInt64 $v, size_t $n1, size_t $n2, size_t $tda where * > $n2 --> Math::Libgsl::Matrix::UInt64) is export {
...
sub uint64-mat-view-array(Math::Libgsl::Matrix::UInt64::View $mv, $array, UInt $size1, UInt $size2 --> Math::Libgsl::Matrix::UInt64) is export {
  Math::Libgsl::Matrix::UInt64.new: matrix => mgsl_matrix_ulong_view_array($mv.view, $array, $size1, $size2);
}
sub uint64-mat-view-array-tda(Math::Libgsl::Matrix::UInt64::View $mv, $array, UInt $size1, UInt $size2, size_t $tda where * > $size2 --> Math::Libgsl::Matrix::UInt64) is export {
  Math::Libgsl::Matrix::UInt64.new: matrix => mgsl_matrix_ulong_view_array_with_tda($mv.view, $array, $size1, $size2, $tda);
}
# Copying matrices

...
unit class Math::Libgsl::Matrix::Int8:ver<0.1.0>:auth<cpan:FRITH>;
...
sub mat-view-array(Math::Libgsl::Matrix::Int8::View $mv, @array where { @array ~~ Array && @array.shape.elems == 2 }) is export {
...
sub mat-view-array-tda(Math::Libgsl::Matrix::Int8::View $mv, @array where { @array ~~ Array && @array.shape.elems == 2 }, size_t $tda) is export {
...
sub mat-view-vector(Math::Libgsl::Matrix::Int8::View $mv, Math::Libgsl::Vector::Int8 $v, size_t $n1, size_t $n2) is export {
  Math::Libgsl::Matrix::Int8.new: matrix => mgsl_matrix_char_view_vector($mv.view, $v.vector, $n1, $n2);
}
sub mat-view-vector-tda(Math::Libgsl::Matrix::Int8::View $mv, Math::Libgsl::Vector::Int8 $v, size_t $n1, size_t $n2, size_t $tda) is export {

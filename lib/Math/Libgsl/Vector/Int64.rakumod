...
unit class Math::Libgsl::Vector::Int64:ver<0.1.3>:auth<cpan:FRITH>;
...
sub vec-view-long-array(Math::Libgsl::Vector::Int64::View $vv, @array) is export(:withsub) {
  my CArray[int64] $a .= new: @array».Int;
  Math::Libgsl::Vector::Int64.new: vector => mgsl_vector_long_view_array($vv.view, $a, @array.elems);
}
sub vec-view-long-array-stride(Math::Libgsl::Vector::Int64::View $vv, @array, size_t $stride) is export(:withsub) {
  my CArray[int64] $a .= new: @array».Int;

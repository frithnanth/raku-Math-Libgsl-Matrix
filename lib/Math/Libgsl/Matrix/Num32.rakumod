...
unit class Math::Libgsl::Matrix::Num32:ver<0.0.6>:auth<cpan:FRITH>;
...
sub mat-view-array(Math::Libgsl::Matrix::Num32::View $mv, @array where { @array ~~ Array && @array.shape.elems == 2 }) is export {
...
sub mat-view-array-tda(Math::Libgsl::Matrix::Num32::View $mv, @array where { @array ~~ Array && @array.shape.elems == 2 }, size_t $tda) is export {
...
sub mat-view-vector(Math::Libgsl::Matrix::Num32::View $mv, Math::Libgsl::Vector::Num32 $v, size_t $n1, size_t $n2) is export {
  Math::Libgsl::Matrix::Num32.new: matrix => mgsl_matrix_float_view_vector($mv.view, $v.vector, $n1, $n2);
}
sub mat-view-vector-tda(Math::Libgsl::Matrix::Num32::View $mv, Math::Libgsl::Vector::Num32 $v, size_t $n1, size_t $n2, size_t $tda) is export {

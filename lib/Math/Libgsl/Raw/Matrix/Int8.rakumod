...
unit module Math::Libgsl::Raw::Matrix::Int8:ver<0.4.1>:auth<zef:frithnanth>;
...
sub gsl_vector_char_scale(gsl_vector_char $a, int8 $x --> int32) is native(&LIB) is export(:vectorop) { * }
sub gsl_vector_char_add_constant(gsl_vector_char $a, int8 $x --> int32) is native(&LIB) is export(:vectorop) { * }
sub gsl_vector_char_sum(gsl_vector_char $a --> int8) is native(&LIB) is export(:vectorop) { * } # v. 2.7
sub gsl_vector_char_axpby(int8 $alpha, gsl_vector_char $x, int8 $beta, gsl_vector_char $y --> int32) is native(&LIB) is export(:vectorop) { * } # v. 2.7
...
sub gsl_matrix_char_scale_rows(gsl_matrix_char $a, gsl_vector_char $x --> int32) is native(&LIB) is export(:matrixop) { * } # v. 2.7
sub gsl_matrix_char_scale_columns(gsl_matrix_char $a, gsl_vector_char $x --> int32) is native(&LIB) is export(:matrixop) { * } # v. 2.7
...
sub gsl_matrix_char_norm1(gsl_matrix_char $a --> int8) is native(&LIB) is export(:matrixprop) { * } # v. 2.7

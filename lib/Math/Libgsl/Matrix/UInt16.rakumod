...
unit class Math::Libgsl::Matrix::UInt16:ver<0.2.0>:auth<cpan:FRITH>;
...
sub uint16-mat-view-vector(Math::Libgsl::Matrix::UInt16::View $mv, Math::Libgsl::Vector::UInt16 $v, size_t $n1, size_t $n2 --> Math::Libgsl::Matrix::UInt16) is export {
  Math::Libgsl::Matrix::UInt16.new: matrix => mgsl_matrix_ushort_view_vector($mv.view, $v.vector, $n1, $n2);
}
sub uint16-mat-view-vector-tda(Math::Libgsl::Matrix::UInt16::View $mv, Math::Libgsl::Vector::UInt16 $v, size_t $n1, size_t $n2, size_t $tda where * > $n2 --> Math::Libgsl::Matrix::UInt16) is export {
...
sub uint16-mat-view-array(Math::Libgsl::Matrix::UInt16::View $mv, $array, UInt $size1, UInt $size2 --> Math::Libgsl::Matrix::UInt16) is export {
  Math::Libgsl::Matrix::UInt16.new: matrix => mgsl_matrix_ushort_view_array($mv.view, $array, $size1, $size2);
}
sub uint16-mat-view-array-tda(Math::Libgsl::Matrix::UInt16::View $mv, $array, UInt $size1, UInt $size2, size_t $tda where * > $size2 --> Math::Libgsl::Matrix::UInt16) is export {
  Math::Libgsl::Matrix::UInt16.new: matrix => mgsl_matrix_ushort_view_array_with_tda($mv.view, $array, $size1, $size2, $tda);
}
# Copying matrices

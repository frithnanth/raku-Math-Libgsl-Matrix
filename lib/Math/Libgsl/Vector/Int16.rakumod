...
unit class Math::Libgsl::Vector::Int16:ver<0.0.6>:auth<cpan:FRITH>;
...
sub view-short-array(Math::Libgsl::Vector::Int16::View $vv, @array) is export {
  my CArray[int16] $a .= new: @array».Int;
  Math::Libgsl::Vector::Int16.new: vector => mgsl_vector_short_view_array($vv.view, $a, @array.elems);
}
sub view-short-array-stride(Math::Libgsl::Vector::Int16::View $vv, @array, size_t $stride) is export {
  my CArray[int16] $a .= new: @array».Int;

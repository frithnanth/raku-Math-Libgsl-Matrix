...
unit class Math::Libgsl::Vector::UInt32:ver<0.1.3>:auth<cpan:FRITH>;
...
sub vec-view-uint32-array(Math::Libgsl::Vector::UInt32::View $vv, @array) is export(:withsub) {
  my CArray[uint32] $a .= new: @array».Int;
  Math::Libgsl::Vector::UInt32.new: vector => mgsl_vector_uint_view_array($vv.view, $a, @array.elems);
}
sub vec-view-uint32-array-stride(Math::Libgsl::Vector::UInt32::View $vv, @array, size_t $stride) is export(:withsub) {
  my CArray[uint32] $a .= new: @array».Int;

...
unit class Math::Libgsl::Vector::UInt16:ver<0.1.0>:auth<cpan:FRITH>;
...
sub view-ushort-array(Math::Libgsl::Vector::UInt16::View $vv, @array) is export(:withsub) {
  my CArray[uint16] $a .= new: @array».Int;
  Math::Libgsl::Vector::UInt16.new: vector => mgsl_vector_ushort_view_array($vv.view, $a, @array.elems);
}
sub view-ushort-array-stride(Math::Libgsl::Vector::UInt16::View $vv, @array, size_t $stride) is export(:withsub) {
  my CArray[uint16] $a .= new: @array».Int;

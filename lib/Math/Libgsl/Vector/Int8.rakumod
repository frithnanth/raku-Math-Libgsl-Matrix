...
unit class Math::Libgsl::Vector::Int8:ver<0.1.4>:auth<cpan:FRITH>;
...
sub vec-view-char-array(Math::Libgsl::Vector::Int8::View $vv, @array) is export(:withsub) {
  my CArray[int8] $a .= new: @array».Int;
  Math::Libgsl::Vector::Int8.new: vector => mgsl_vector_char_view_array($vv.view, $a, @array.elems);
}
sub vec-view-char-array-stride(Math::Libgsl::Vector::Int8::View $vv, @array, size_t $stride) is export(:withsub) {
  my CArray[int8] $a .= new: @array».Int;

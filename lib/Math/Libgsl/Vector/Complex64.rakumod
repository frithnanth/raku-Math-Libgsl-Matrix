...
unit class Math::Libgsl::Vector::Complex64:ver<0.1.3>:auth<cpan:FRITH>;
...
sub vec-view-complex64-array(Math::Libgsl::Vector::Complex64::View $vv, @array) is export(:withsub) {
  my CArray[num64] $a .= new: @array».Num;
  Math::Libgsl::Vector::Complex64.new: vector => mgsl_vector_complex_view_array($vv.view, $a, (@array.elems / 2).Int);
}
sub vec-view-complex64-array-stride(Math::Libgsl::Vector::Complex64::View $vv, @array, size_t $stride) is export(:withsub) {
  my CArray[num64] $a .= new: @array».Num;
  Math::Libgsl::Vector::Complex64.new: vector => mgsl_vector_complex_view_array_with_stride($vv.view, $a, $stride, (@array.elems / 2).Int);
}

...
sub mat-view-array(Math::Libgsl::Matrix::Int32::View $mv, @array where { @array ~~ Array && @array.shape.elems == 2 }) is export {
...
sub mat-view-array-tda(Math::Libgsl::Matrix::Int32::View $mv, @array where { @array ~~ Array && @array.shape.elems == 2 }, size_t $tda) is export {
...
sub mat-view-vector(Math::Libgsl::Matrix::Int32::View $mv, Math::Libgsl::Vector::Int32 $v, size_t $n1, size_t $n2) is export {
  Math::Libgsl::Matrix::Int32.new: matrix => mgsl_matrix_int_view_vector($mv.view, $v.vector, $n1, $n2);
}
sub mat-view-vector-tda(Math::Libgsl::Matrix::Int32::View $mv, Math::Libgsl::Vector::Int32 $v, size_t $n1, size_t $n2, size_t $tda) is export {

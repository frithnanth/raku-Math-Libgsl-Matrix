...
sub view-uchar-array(Math::Libgsl::Vector::UInt8::View $vv, @array) is export {
  my CArray[uint8] $a .= new: @array».Int;
  Math::Libgsl::Vector::UInt8.new: vector => mgsl_vector_uchar_view_array($vv.view, $a, @array.elems);
}
sub view-uchar-array-stride(Math::Libgsl::Vector::UInt8::View $vv, @array, size_t $stride) is export {
  my CArray[uint8] $a .= new: @array».Int;

...
unit class Math::Libgsl::Matrix::UInt16:ver<0.0.6>:auth<cpan:FRITH>;
...
sub mat-view-array(Math::Libgsl::Matrix::UInt16::View $mv, @array where { @array ~~ Array && @array.shape.elems == 2 }) is export {
...
sub mat-view-array-tda(Math::Libgsl::Matrix::UInt16::View $mv, @array where { @array ~~ Array && @array.shape.elems == 2 }, size_t $tda) is export {
...
sub mat-view-vector(Math::Libgsl::Matrix::UInt16::View $mv, Math::Libgsl::Vector::UInt16 $v, size_t $n1, size_t $n2) is export {
  Math::Libgsl::Matrix::UInt16.new: matrix => mgsl_matrix_ushort_view_vector($mv.view, $v.vector, $n1, $n2);
}
sub mat-view-vector-tda(Math::Libgsl::Matrix::UInt16::View $mv, Math::Libgsl::Vector::UInt16 $v, size_t $n1, size_t $n2, size_t $tda) is export {
